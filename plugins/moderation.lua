...
local function mute_by_reply(extra, success, result)
    ...
    redis:set(hash, true)
    if msg.to.type == 'chat' then
        send_msg('chat#id'..chat, '#️ '..lang_text(chat, 'userMuted:1')..' '..name..' ('..user..') '..lang_text(chat, 'userMuted:2'), ok_cb,  true)
    elseif msg.to.type == 'channel' then
...
local function chat_kick(extra, success, result)
    ...
    elseif chat_type == 'channel' then
        ...
        send_msg('channel#id'..chat, '#️ '..lang_text(chat, 'kickUser:1')..' '..user..' '..lang_text(chat, 'kickUser:2'), ok_cb,  true)
    end
end
...
local function gban_by_reply(extra, success, result)
    ...
    elseif msg.to.type == 'channel' then
        channel_kick_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
        send_msg('channel#id'..chat, '#️ '..lang_text(chat, 'gbanUser:1')..' '..user..' '..lang_text(chat, 'gbanUser:2'), ok_cb,  true)
    end
end
...
local function gban_by_username(cb_extra, success, result)
    ...
    if chat_type == 'chat' then
        ...
        chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '#️ '..lang_text(chat_id, 'gbanUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'gbanUser:2'), ok_cb, false)
        channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    end
end
        ...
        if permissions(msg.from.id, msg.to.id, "gban") then
            ...
            if not is_id(matches[2]) then
                ...
                if chat_type == 'chat' then
                    ...
                    chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                elseif chat_type == 'channel' then
                    send_msg('channel#id'..chat_id, '#️ '..lang_text(chat_id, 'gbanUser:1')..' '..user_id..' '..lang_text(chat_id, 'gbanUser:2'), ok_cb, false)
                    channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                end
                return
            end
